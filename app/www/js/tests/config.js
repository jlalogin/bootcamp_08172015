...
define({
	...
	suites: [
		"/js/tests/models/account",
		//"/js/tests/models/userFile",
		"/js/tests/collections/accounts",
		//"/js/tests/collections/userFiles",
		"/js/tests/views/viewAccount",
		//"/js/tests/views/editAccount",
		"/js/tests/routers/accountRouter"
	],
